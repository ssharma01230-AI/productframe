...
- Channel: `ecommerce`
- Document key: `06_rear_product` (documentation identifier, not a registered runtime template ID)
- Presentation mode: `invisible_mannequin`
- Benchmark: [View image](references/06_rear_product.png)
...
Supplied 06; centre seam, long overlapping rear vent and small diagonal stitch at vent top are visible benchmark details, not generic coat requirements.
...
- Camera angle and orientation: Straight-on rear view at garment mid-height.
- Framing and crop: Complete coat with collar, both cuffs and hem inside frame.
- Product position and pose: Centred upright rear silhouette, sleeves lowered with slim gaps.
...
- Visible construction: Actual back panels, seams, vents and sleeve construction where evidenced.
- Garment volume: Softly supported back and shoulder volume with no visible mannequin.
...
- Required visual coverage for faithful reproduction: Full rear reference including vent/hem and sleeves.
