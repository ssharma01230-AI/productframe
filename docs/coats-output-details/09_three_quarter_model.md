# Coats — Model Front Three-Quarter — Cropped
...
Supplied 09; front-oblique rather than rear view; preserve anatomical placement instead of mirroring product features.
...
- Camera angle and orientation: Front three-quarter, near shoulder and sleeve at image right; model turns slightly toward image left.
- Framing and crop: Neck base through both hands; lower coat exits bottom edge, face and feet excluded.
- Product position and pose: Torso centred with near side foregrounded, both arms down and hands outside pockets.
...
- Visible construction: Actual front and near-side collar, fastenings, pockets and sleeve details.
- Garment volume: Natural worn depth through shoulder, chest and near sleeve, no exaggerated twist.
...
- Required visual coverage for faithful reproduction: Front plus near-side reference to support newly revealed side details.
