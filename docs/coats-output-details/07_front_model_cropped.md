# Coats — Model Front Facing — Cropped

- Global category: `outerwear`
- Eligible family: `coats` only
- Channel: `ecommerce`
- Document key: `07_front_model_cropped` (documentation identifier, not a registered runtime template ID)
- Presentation mode: `model`
- Benchmark: [View image](references/07_front_model_cropped.png)
...
Supplied 07; this is a torso crop, not a full-coat view. Do not shorten a long coat to fit its hem into the frame.
...
- Visible construction: Actual front closure, collar, pockets and cuffs within crop.
- Garment volume: Natural closed-coat fit with subtle elbow and torso folds.
...
- Required visual coverage for faithful reproduction: Clear front reference resolving neckline, closures, pockets and sleeves.
